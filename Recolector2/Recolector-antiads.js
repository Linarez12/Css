function go_to_player(url) {
    ...
    <iframe onload='document.querySelector(".BotHumano").classList.remove("BotHumanoA")' sandbox="allow-same-origin allow-scripts" id="IFR" src="` + url + `" frameborder="0" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>`;
    }
